...
\begin{table}
    \caption{Comparing the mean performance of the algorithms on the datasets using 10-fold cross-validation}

    \input[width=\textwidth]{../../out/tables/datasetmatrix.tex}
